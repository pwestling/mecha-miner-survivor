...
section "1. the pure tier runs, discovers a nonzero test count, and launches no Godot"
#
...
if grep -q 'FAIL  no-godot-launched: the pure tier tried to launch Godot' <<<"${violation_output}"; then
