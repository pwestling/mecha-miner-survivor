...
- [DEC-128 — Set the extraction-zone and resonance-field radii](./DEC-128-set-extraction-zone-and-resonance-field-radii.md) — accepted 3.0M extraction-zone radius and 6.0M geode resonance-field radius; per-resource zone-size variation open
