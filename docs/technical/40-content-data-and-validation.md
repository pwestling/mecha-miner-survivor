...
The closed vocabularies behind the fields named above are granted at [Minted value vocabularies](#minted-value-vocabularies), which is where their members and each member's provenance live; naming a field here is not granting its vocabulary.
