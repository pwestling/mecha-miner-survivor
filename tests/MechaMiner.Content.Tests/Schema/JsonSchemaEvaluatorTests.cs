...
internal sealed class JsonSchemaEvaluatorTests
{
    ...
    [TestCase("{\"minLength\":2}", "\"ab\"", true)]
    [TestCase("{\"minLength\":2}", "\"a\"", false)]
    ...
    [TestCase("{\"allOf\":[{\"type\":\"string\"},{\"minLength\":2}]}", "\"ab\"", true)]
    [TestCase("{\"allOf\":[{\"type\":\"string\"},{\"minLength\":2}]}", "\"a\"", false)]
