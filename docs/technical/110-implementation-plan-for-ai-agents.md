...
| `TASK-FND-003-001` | create pure NUnit projects, shared deterministic fixture utilities, and sample unit/property/golden tests | FND-001 Done | pure test projects/support | tests run without Godot and expose seed/reproduction on failure |
